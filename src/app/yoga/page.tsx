...
export const metadata: Metadata = {
  title: 'Yoga Classes - Yoga Lab',
  description: 'Your yoga mat is a laboratory. Discover strength in your yoga practice that translates to strength in your life.',
};
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">REGULATE</h2>
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            <div className="relative pl-16">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Experience regulated movement and breathwork that promotes deeper physical and mental health. 
