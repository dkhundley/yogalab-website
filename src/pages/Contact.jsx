            ...
            <dl className="mt-8 space-y-6">
              ...
              <div>
                ...
                <dd className="flex">
                  ...
                  <a href="mailto:info@theyogalab.org" className="text-indigo-600 hover:text-indigo-500">
                    info@theyogalab.org
                  </a>
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="flex">
                  ...
                  <a href="http://www.instagram.com/yogalab.bn" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-500">
                    @yogalab.bn
                  </a>
                </dd>
              </div>
