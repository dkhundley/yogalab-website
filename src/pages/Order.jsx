    ...
    <div className="bg-black font-body">
      <div className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center mb-12">
            <h2 className="text-base font-subheading leading-7 text-white">ORDER AHEAD</h2>
            ...
            <div className="bg-gray-900 rounded-lg p-8">
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-white mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 pb-8">
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-t-xl px-6 py-4 flex items-center justify-between shadow-lg">
            <div className="flex items-center gap-3">
              <span className="text-black text-sm font-semibold">Square Online Ordering</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              {isFullscreenSupported && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-gray-300 hover:bg-gray-400 transition-colors text-black text-xs font-medium"
          ...
          <div 
            ...
            className="relative w-full bg-white rounded-b-xl shadow-2xl border-4 border-gray-200 border-t-0" 
