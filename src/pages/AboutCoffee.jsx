    ...
    <div className="bg-white py-24 sm:py-32 font-montserrat">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-black">ABOUT LAB COFFEE</h2>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Quality & Care</h4>
                  <p className="text-gray-600">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Intentional Space</h4>
                  <p className="text-gray-600">
        ...
        {/* Our Offerings */}
        <div className="mx-auto mt-16 max-w-4xl">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">What We Offer</h3>
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <div className="bg-black text-white rounded-2xl p-8 lg:p-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Move, breathe, and rest in Yoga Lab</p>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">Relate</div>
                <p className="text-gray-300 text-sm">Connect and build community at Lab Coffee</p>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">Reason</div>
                <p className="text-gray-300 text-sm">Transform interactions in your daily life</p>
              </div>
            </div>
          </div>
        </div>
