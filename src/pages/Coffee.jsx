      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <div className="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3">
            <div className="flex flex-col">
              ...
              <dt className="mt-4 font-semibold text-white">Community Connection</dt>
            ...
            <div className="flex flex-col">
              ...
              <dt className="mt-4 font-semibold text-white">Quality Ingredients</dt>
              <dd className="mt-2 leading-7 text-gray-300">
            ...
            <div className="flex flex-col">
              ...
              <dt className="mt-4 font-semibold text-white">Relaxing Atmosphere</dt>
              <dd className="mt-2 leading-7 text-gray-300">
        ...
        <div className="mx-auto mt-32 max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            {menuItems.map((section) => (
              <div key={section.category} className="bg-gray-900 rounded-lg p-8">
                <h4 className="text-xl font-bold text-white mb-6">{section.category}</h4>
                <div className="space-y-4">
                  {section.items.map((item) => (
                    <div key={item.name}>
                      <dt className="font-semibold text-white">{item.name}</dt>
                      <dd className="text-gray-300 text-sm">{item.description}</dd>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/order"
              className="rounded-md bg-white px-8 py-3 text-base font-semibold text-black shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors"
            >
              Order Online
            </Link>
            <Link
              to="/contact"
              className="rounded-md border-2 border-white px-8 py-3 text-base font-semibold text-white shadow-sm hover:bg-gray-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-colors"
            >
              Visit Us Today
            </Link>
          </div>
